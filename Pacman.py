...
class Ghost:
    def __init__(self, row, col, color, changeFeetCount, algorithm = 'BFS'): #!!!
        self.row = row
        self.col = col
        self.attacked = False
        self.color = color
    ...
    def setDir(self): #Informed Breadth-First-Search based on direction of Pacman
        ...
        if self.algorithm == 'BFS':
            ...
            for newDir in dirs:
                g = 1
                h = abs(self.target[0] - (self.row + newDir[1])) + abs(self.target[1] - (self.row + newDir[2])) # Manhattan Distance - Approximation stics
...
def displayLaunchScreen():
    # Draw Pacman Title
    pacmanTitle = ["tile016.png", "tile000.png", "tile448.png", "tile003.png", "tile014.png", "tile012.png"]
    ...
    characters = [
        ...
        [
            ...
            "tile108.png", "tile067.png", "tile078.png", "tile066.png", "tile108.png"
        ],
        # Pink Ghost
        [
    ...
    # Credit myself
    credit = ["tile003.png", "tile014.png", "tile012.png", "tile008.png", "tile013.png", "tile008.png", "tile017.png", "tile021.png", "tile004.png", "tile015.png", "tile010.png", "tile004.png", "tile011.png", "tile011.png", "tile000.png", "tile012.png", "tile015.png", "tile418.png", "tile416.png", "tile418.png", "tile419.png"]
    for i in range(len(credit)):
        letter = pygame.image.load(TextPath + credit[i])
        letter = pygame.transform.scale(letter, (int(square), int(square)))
        screen.blit(letter, ((3.5 + i) * square, 30 * square, square, square))
    # Press Space to Play
